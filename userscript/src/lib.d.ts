declare module "lib" {
    ...
    export namespace PVPClient {
        ...
        export const SendBuffer: Uint8Array;
        const CONNECT_2: string;
        export { CONNECT_2 as CONNECT };
        const DISCONNECT_3: string;
        export { DISCONNECT_3 as DISCONNECT };
        export const AUTH_FAILED: string;
        export const SERVER_FULL: string;
        export const CONNECTION_ERROR: string;
        export const CODE_AUTH_FAILED: number;
        export const CODE_MAX_CLIENTS: number;
        export const CODE_DUPLICATE_CLIENT: number;
