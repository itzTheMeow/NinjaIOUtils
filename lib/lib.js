...
export class SettingsPanel extends PIXI.Container {
  ...
  constructor(a, b) {
    ...
    this.controlsTabButton = new PIXI.Text("Controls", FontStyle.MediumMenuTextOrange);
    this.controlsTabButton.resolution = 2;
    ...
    this.graphicsTabButton = new PIXI.Text("Display", FontStyle.MediumMenuTextOrange);
    this.graphicsTabButton.resolution = 2;
    ...
    this.soundTabButton = new PIXI.Text("Sound", FontStyle.MediumMenuTextOrange);
    this.soundTabButton.resolution = 2;
...
export class Button extends PIXI.Graphics {
  constructor(id, icon = null, c = null, d = null) {
    super();
    ...
    null !== icon && ((this.image = new PIXI.Sprite(icon)), this.addChild(this.image));
    null !== c &&
  ...
  setText(text, x = 0, y = 5) {
    this.text ? (this.text.text = text) : (this.text = new PIXI.Text(text, FontStyle.ButtonTitle));
...
export class InputField extends PIXI.Container {
  constructor(id, noMouse = !1, fontSize = 26, bitmap = !1) {
    super();
    EventDispatcher.call(this);
    this.id = id || "button";
    this.focus = !1;
    ...
    this.text = bitmap
      ? new PIXI.BitmapText("", { fontName: "Open Sans", align: "left", fontSize: fontSize })
    ...
    this.background.interactive = !0;
    noMouse || this.addChild(this.background);
    this.addChild(this.marker);
    this.addChild(this.text);
    ...
    this.text.x = 18 - 0.25 * (26 - fontSize);
    this.text.y = (bitmap ? 30 : 35) - 0.25 * (26 - fontSize);
    this.passwordText.x = 18 - (26 - fontSize);
    this.passwordText.y = (bitmap ? 30 : 34) - 0.25 * (26 - fontSize);
    this.passwordMode = !1;
  ...
  setFilter(filter, inversed) {
    this.filtered = filter;
    this.inversed = inversed || !1;
  }
  onMouseDown(a) {
...
export const AudioFolder =
  ...
  AudioEffects = {
    ...
    Boomerang: {
      audio: new Howl({ src: [AudioFolder + "boomerang.mp3"], volume: 1 }),
      single: !0,
      sub_start: 0,
      sub_end: 2,
    },
